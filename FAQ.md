...
All registrations require an Expert Review; to make a request do one of the following:

1. Send email iana@iana.org; this email SHOULD use an appropriate subject (e.g., "Request to register value in TLS bar registry")
2. Use the online form at https://www.iana.org/form/protocol-assignment
